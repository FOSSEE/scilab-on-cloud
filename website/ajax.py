...
def examples(request, chapter_id):
    ...
    if chapter_id:
        ...
        example_views_count = TextbookCompanionExampleViews.objects\
            .using('scilab').filter(chapter_id=chapter_id)
        ...
        context = {
            ...
            "img_thumb": "<img src='static/website/images/code-thumbnails/"
                         "code1.png' style='width:100%;height:100%;"
...
def revision_form_submit(request, form, code):
    ...
    if form.is_valid():
        ...
        if commit_sha is not None:
            ...
            dajax.alert(
                'submitted successfully! \nYour changes will be visible after '
                'review.')
